    ...
    return (
        <div className="flex flex-col bg-bg5 w-full mt-5">
            ...
            <div className="flex flex-col md:flex-row-reverse justify-evenly">
                ...
                <img src={Image9} alt="" className="h-44 md:mb-14 md:h-52 lg:h-56 xl:h-72 2xl:h-80 m-auto md:mr-14 lg:mr-20 xl:mr-28 2xl:mr-40"/>

                <div className="p-5 w-full px-6 md:ml-14 lg:ml-20 xl:ml-28 2xl:ml-40"  onClick={closeingOtherTags}>
                    <details className="bg-bg51 cursor-pointer border-4 border-black p-2 md:p-4 shadow-lg rounded-lg mt-3">
                        <summary className="list-none text-lg flex items-center justify-between"><h1>How much to mint a SHIBA DAY?</h1><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 float-right text-primary" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd"/></svg></summary>
                    ...
                    <details className="bg-bg51 cursor-pointer border-4 border-black p-2 md:p-4 shadow-lg rounded-lg mt-3">
                        <summary className="list-none text-lg flex items-center justify-between"><h1>How many SHIBA DAY exist and how big can my squad be?</h1><section><svg xmlns="http://www.w3.org/2000/svg" className="h-6 float-right text-primary" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd"/></svg></section></summary>
                    ...
                    <details className="bg-bg51 cursor-pointer border-4 border-black p-2 md:p-4 shadow-lg rounded-lg mt-3 mb-10">
